...
import { ZFB_FEE_TYPE_GROUPS, ZFB_FEE_TYPE_MAP } from './batchStatBuilder';

// 「费用分类」映射（分类 → 推广费用 / 平台费用 / 其他）已抽到 batchStatBuilder
// （ZFB_FEE_TYPE_GROUPS / ZFB_FEE_TYPE_MAP），弹窗与「批量导出」共用同一份，
// 避免口径在两端各自维护而漂移。
